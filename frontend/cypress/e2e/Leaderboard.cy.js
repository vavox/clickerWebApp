...
context('Location', () => {
  ...
  it('cy.location() - get window.location', () => {
    ...
    cy.location().should((location) => {
      ...
      expect(location.href).to.eq('http://192.168.1.135:8080/leaderboard')
      ...
      expect(location.pathname).to.eq('/leaderboard')
  ...
  it('cy.url() - get the current URL', () => {
    ...
    cy.url().should('eq', 'http://192.168.1.135:8080/leaderboard')
  })
})
  ...
  describe('Implicit Assertions', () => {
    it('.should() - make an assertion about the current subject', () => {
      ...
      cy.get('.leaderboard-table')
        .find('tr')
        //.find('th')
        .should('have.text', 'NameLevelTotal BytesBytes')
