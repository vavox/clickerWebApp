...
describe('Text', () => {
  it('Visits the app root url', () => {
    cy.visit('http://192.168.1.135:8080/game')
    cy.contains('h3', 'Current Bytes')
  })
})
...
context('Location', () => {
  ...
  it('cy.location() - get window.location', () => {
    ...
    cy.location().should((location) => {
      ...
      expect(location.href).to.eq('http://192.168.1.135:8080/game')
  ...
  it('cy.url() - get the current URL', () => {
    ...
    cy.url().should('eq', 'http://192.168.1.135:8080/game')
  })
})
