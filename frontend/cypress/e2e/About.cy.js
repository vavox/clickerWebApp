...
context('Location', () => {
  ...
  it('cy.location() - get window.location', () => {
    ...
    cy.location().should((location) => {
      ...
      expect(location.href).to.eq('http://192.168.1.135:8080/aboutapp')
      ...
      expect(location.pathname).to.eq('/aboutapp')
  ...
  it('cy.url() - get the current URL', () => {
    ...
    cy.url().should('eq', 'http://192.168.1.135:8080/aboutapp')
  })
})
